...
try:
    ...
    st.warning(f"⚠️ Google Sheets connection issue: {e}")
...
proj_display = proj_display.astype(str)  # Convert to string to avoid PyArrow errors
